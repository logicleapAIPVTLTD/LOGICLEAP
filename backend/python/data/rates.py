...
BOM_FILE = SCRIPT_DIR / "predicted_bom.xlsx"
ITEM_RATE_FILE = SCRIPT_DIR / "ITEM_RATE_BASE_MASTER.xlsx"
LABOUR_RATE_FILE = SCRIPT_DIR / "Labour_Base_Rates.xlsx"
MACHINE_RATE_FILE = SCRIPT_DIR / "Machinery_Base_Rates.xlsx"
STATE_FILE = SCRIPT_DIR / "STATE_CITY_INDEX_MASTER.xlsx"
MAPPING_FILE = SCRIPT_DIR / "ITEM_CLASSIFICATION_MASTER.xlsx"
...
def calculate_estimation(state_code, city_tier, bom_file=None, detailed=False):
    ...
    try:
        ...
        bom_path = Path(bom_file) if bom_file else BOM_FILE
        if not bom_path.exists():
            bom_path = SCRIPT_DIR / bom_file if bom_file else BOM_FILE
